...
function ExerciseItem({ title, temaId, sectionType, skeleton }: ExerciseItemProps) {
  if (skeleton)
    return (
      ...
      >
        <div className='aspect-195/172 grow shadow-cogtec flex-col justify-end items-center animate-pulse px-6 py-3 rounded-xl gap-2.5 shadow-current bg-beige-50 flex'>
