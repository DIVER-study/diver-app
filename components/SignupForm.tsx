      ...
      >
        ...
        <div className='flex items-center gap-2 mt-8 mb-3'>
          <label className='flex items-center gap-2 cursor-pointer'>
            ...
            />
            <span className='w-4 h-4 flex items-center justify-center border-2 border-logo-200 rounded-sm peer-checked/check:bg-logo-200 bg-white text-white *:hidden peer-checked/check:*:block'>
            ...
            <button
              ...
              className='text-sm text-[#1E2772] underline underline-offset-1 cursor-pointer'
            >
