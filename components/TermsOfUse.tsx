...
export function TermsOfUse({
  ...
  return (
    <div
      className='fixed w-full h-screen open:flex justify-center bg-black/50 hidden max-h-[100dvh] overflow-y-auto'
      {...props}
    >
      <div className='h-fit p-8 max-w-3xl bg-beige-50 rounded-3xl relative flex flex-col items-end text-start'>
        <button
          onClick={action}
          type='button'
          className='sticky top-4 right-4 cursor-pointer'
        >
          <CloseIcon
            width={20}
            height={20}
        ...
        <h1 className='text-3xl mt-15 font-bold mb-10 w-full'>Termos e Condições de Uso - CogTec</h1>
        ...
        <p className='text-base font-medium'>
          Ao acessar e utilizar o CogTec, você concorda em cumprir e estar vinculado aos seguintes termos e condições. A
          nossa missão é proporcionar uma experiência educacional inovadora e envolvente, e esses termos visam garantir
          a segurança, a integridade e o respeito em nossa comunidade de aprendizes de programação.
        </p>
        <br />

        <p className='text-base font-medium'>
          Por favor, leia atentamente os Termos e Condições a seguir. Se tiver alguma dúvida ou preocupação, não hesite
          em entrar em contato conosco (email de alguém). Ao continuar a utilizar o CogTec, você reconhece que
        ...
        <ol>
          ...
          <p className='text-base font-medium'>
               Entende e concorda com a nossa Política de Privacidade, que descreve como coletamos, usamos e protegemos
        ...
        <p className='text-base font-medium'>
          ...
          nessa jornada educacional única. Se precisar de esclarecimentos adicionais ou tiver alguma preocupação, entre
          em contato conosco.
        </p>
        <br />
        <p className='w-full'>Boas vindas ao CogTec!</p>
      </div>
    </div>
  );
}
